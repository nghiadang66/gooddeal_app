...
import { listTransactionsByUser } from '../../services/transaction';
...
const UserCoin = ({ navigation, route }) => {
    ...
    const init = () => {
        setError('');
        setIsLoading(true);
        listTransactionsByUser(jwt._id, jwt.accessToken, filter)
                .then(data => {
    ...
    return (
        <>
            <FloatBtn icon='wallet' type='gold' onPress={() => navigation.navigate('UserWithdraw')} />
            <ScrollView>
